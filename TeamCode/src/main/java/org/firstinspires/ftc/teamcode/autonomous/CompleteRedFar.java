...
@Autonomous(name="CompleteRedFar")
@Config
public class CompleteRedFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action mainTrajLeft = drive.actionBuilder(startPose)
                ...
                .afterTime(1,  linearSlides.setTargetPosition(1400))
        ...
        Action mainTrajRight = drive.actionBuilder(startPose)
                ...
                .setReversed(true)
                .strafeTo(new Vector2d(-36 ,-45))
                .splineToSplineHeading(new Pose2d(-40.5,-33, Math.toRadians(180)), Math.toRadians(-90)) //x was -38 before
                .endTrajectory()
                .stopAndAdd(intake.idle())
                .setReversed(true)
                .setTangent(0)
                ...
                .afterTime(1,  linearSlides.setTargetPosition(1400))
                .splineToSplineHeading(new Pose2d(54,-26.5, Math.toRadians(180)), Math.toRadians(0))
                .strafeTo(new Vector2d(58.0, -26.5),
                        new TranslationalVelConstraint(10.0))
                .endTrajectory()
                .waitSeconds(1)
                .stopAndAdd(dropper.dropDown())
        ...
        Action mainTrajMiddle = drive.actionBuilder(startPose)
                ...
                .strafeTo(new Vector2d(54,-39))
                .strafeTo(new Vector2d(58.0, -39),
                        new TranslationalVelConstraint(10.0))
                .endTrajectory()
                .waitSeconds(1)
                .stopAndAdd(dropper.dropDown())
